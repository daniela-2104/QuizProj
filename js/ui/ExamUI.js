...
export class ExamUI {
    //get service for CRUD opertion on exam
    //CRUD = creat read udeat deleta
    constructor(examService) {

        //get references to UI element
    ...
    //render exam list (js object) display in UI
    renderExamList() {
        ...
        exams.forEach(exam => {
            ...
            div.innerHTML = `
                ...
                <button class="btn btn-sm btn-success run-btn" data-id="${exam.id}">
                 Run Exam
                </button>
    ...
    renderExamRunner(exam) {
        ...
        exam.questions.forEach((question, questionIndex) => {
            ...
            //מקבל תשובות ומייצר ממנו תת מערך של תגיות של HTML ואז נפתח למחרזות אחת ארוכה 
